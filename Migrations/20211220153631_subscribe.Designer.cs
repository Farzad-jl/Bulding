...
namespace BacendBulding.Migrations
{
    ...
    [Migration("20211220153631_subscribe")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BacendBuldinghamid.Database.Corse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BacendBuldinghamid.Database.Subscibe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ManageAccountMobile")
                        .HasColumnType("nvarchar(10)");
                    ...
                    b.HasIndex("ManageAccountMobile");
            ...
            modelBuilder.Entity("BacendBuldinghamid.Database.Subscibe", b =>
                {
                    b.HasOne("BacendBuldinghamid.Database.Corse", "Corse")
                        .WithMany()
                        .HasForeignKey("CorseId");

                    b.HasOne("BacendBulding.Database.Manage", "Manage")
                        .WithMany()
                        .HasForeignKey("ManageAccountMobile");
